...
{
	[TestFixture]
	public class AddedCompilationAlbumWithArtistInfoTests
	{
		[Test]
		public void RequiredDataIsFilled_WhenGenreIsNotFilled_ReturnsFalse()
		{
			var album = new AddedCompilationAlbumWithArtistInfo(Arg.Any<string>(), new AlbumInfo(Enumerable.Empty<SongInfo>()),
