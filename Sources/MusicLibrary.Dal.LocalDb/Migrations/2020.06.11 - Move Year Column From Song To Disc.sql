...
INSERT INTO Discs(Id, Folder_Id, Year, Title, TreeTitle, AlbumTitle) SELECT Id, Folder_Id, Year, Title, TreeTitle, AlbumTitle FROM OldDiscs;
INSERT INTO Artists(Id, Name) SELECT Id, Name FROM OldArtists;
INSERT INTO Genres(Id, Name) SELECT Id, Name FROM OldGenres;
INSERT INTO Songs(Id, Artist_Id, Disc_Id, Genre_Id, TrackNumber, Title, TreeTitle, Duration, Rating, FileSize, Checksum, Bitrate, LastPlaybackTime, PlaybacksCount, DeleteDate)
           SELECT Id, Artist_Id, Disc_Id, Genre_Id, TrackNumber, Title, TreeTitle, Duration, Rating, FileSize, Checksum, Bitrate, LastPlaybackTime, PlaybacksCount, DeleteDate FROM OldSongs;
